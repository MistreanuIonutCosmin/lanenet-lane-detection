...
def init_args():
    ...
    parser.add_argument('--model_save_dir', type=str, help='model dir', default='./model/mobilenet_duplicate_deconv')
    parser.add_argument('--tboard_save_dir', type=str, help='tboard dir', default='./tboard/mobilenet_duplicate_deconv')
